...
public class JalaliCalendar extends Calendar {
    ...
    public static final String[] persian_days = {
            "شنبه",
            "یکشنبه",
            "دوشبنه",
            "سه شنبه",
    ...
    public String getJalaliDateAsString(Date gDate) {
    ...
    public YearMonthDate getJalaliDate(Date gDate) {
        ...
        return gregorianToJalali(gMyDate);
    }
    ...
    public static class YearMonthDate {
        ...
        public String getMonthName(){ return monthNames[month];}
...
//            return getYear() + "/" + getMonth() + "/" + getDate();
        ...
        public String toString(boolean withMonthName){
            if(withMonthName){
