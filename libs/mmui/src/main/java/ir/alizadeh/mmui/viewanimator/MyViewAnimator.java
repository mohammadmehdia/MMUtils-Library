package ir.alizadeh.mmui.viewanimator;
...
public class MyViewAnimator {
    ...
    private MyViewAnimator prev = null;
    private MyViewAnimator next = null;
    ...
    public static AnimationBuilder animate(View... view) {
        MyViewAnimator viewAnimator = new MyViewAnimator();
        return viewAnimator.addAnimationBuilder(view);
    }

    public AnimationBuilder thenAnimate(View... views) {
        MyViewAnimator nextViewAnimator = new MyViewAnimator();
     ...
     */
    public MyViewAnimator repeatCount(@IntRange(from = -1) int repeatCount) {
    ...
    public MyViewAnimator duration(@IntRange(from = 1) long duration) {
        this.duration = duration;
        return this;
    }

    public MyViewAnimator startDelay(@IntRange(from = 0) long startDelay) {
    ...
    public MyViewAnimator repeatMode(@RepeatMode int repeatMode) {
        this.repeatMode = repeatMode;
        return this;
    }

    public MyViewAnimator onStart(AnimationListener.Start startListener) {
        this.startListener = startListener;
        return this;
    }

    public MyViewAnimator onStop(AnimationListener.Stop stopListener) {
     ...
     */
    public MyViewAnimator interpolator(Interpolator interpolator) {
