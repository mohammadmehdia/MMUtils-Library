...
public class CustomPager extends ClickableViewPager {

    private static final String TAG = CustomPager.class.getSimpleName();
    ...
    public void setAdapter(PagerAdapter adapter) {
        if(!(adapter instanceof ObjectAtPositionInterface)) {
            throw new IllegalArgumentException("ViewPager requires that PagerAdapter will implement ObjectAtPositionInterface");
        }
