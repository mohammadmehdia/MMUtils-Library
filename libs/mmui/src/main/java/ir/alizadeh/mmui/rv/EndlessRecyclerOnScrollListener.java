...
//                    throw new RuntimeException("A LayoutManager is required")
    ...
    public void resetPageCount() {
        this.resetPageCount(0, false);
    }
    public void resetPageCount(boolean loadMore){
        this.resetPageCount(0, loadMore);
    }

    public void resetPageCount(int page, boolean loadMore) {
        mPreviousTotal = 0;
        mLoading = true;
        currentPage = page;
        if(loadMore) {
