...
@BindingMethods({
        @BindingMethod(type= MyTextView.class, attribute = "mytv_isBold", method = "setBold"),
})
public class MyTextView extends AppCompatTextView {
    ...
    private void refresh() {
        checkFontPath();
        debug("refresh: fontPath = " + fontPathAttr + " | text = " + this.getText());
    ...
    private void debug(String text, boolean force) {
        if( (force || isDebugEnabled) && !TextUtils.isEmpty(text)) {
            ...
            Log.d("MyTV", "(hasBoldAttr:" + hasAttrIsBold + ", isBold: " + isBold + ")" + text);
        }
    }
