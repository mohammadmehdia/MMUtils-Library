...
public class AnimationBuilder {
    private final MyViewAnimator viewAnimator;
    ...
    public AnimationBuilder(MyViewAnimator viewAnimator, View... views) {
    ...
    public AnimationBuilder repeatMode(@MyViewAnimator.RepeatMode int repeatMode) {
    ...
    public MyViewAnimator accelerate() {
        return viewAnimator.interpolator(new AccelerateInterpolator());
    }

    public MyViewAnimator decelerate() {
    ...
    public AnimationBuilder slideLeftOut() {
        translationX(0, -5000);
        alpha(0, 1);
        return this;
    }

    public AnimationBuilder slideRightOut() {
        translationX(0, 5000);
        alpha(0, 1);
        return this;
    }

    public AnimationBuilder slideTopOut() {
        translationY(0, -5000);
        alpha(0, 1);
        return this;
    }

    public AnimationBuilder slideBottomOut() {
        translationY(0, 5000);
        alpha(0, 1);
        return this;
    }
